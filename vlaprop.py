    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                bias_correction1 = state['exp_avg_lr_1'] / group['lr'] if group[
                                                                              'lr'] != 0. else 1.  # 1 - beta1 ** state['step']
...
class VLaProp(Optimizer):
    def __init__(self, params, lr=4e-4, betas=(0.9, 0.999), eps=1e-15,
                 weight_decay=0, amsgrad=False, centered=False, v=1, alpha=1, auto_v=True):
        ...
        super(VLaProp, self).__init__(params, defaults)
